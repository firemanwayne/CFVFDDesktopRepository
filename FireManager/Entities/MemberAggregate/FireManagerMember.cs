...
namespace FireManager.Entities.MemberAggregate
{
    public class FireManagerMember
    {
        public FireManagerMember() { }
        private FireManagerMember(Member Member)
        {
        ...
        public static FireManagerMember Instance(Member Member)
        {
            return new FireManagerMember(Member);
        }
